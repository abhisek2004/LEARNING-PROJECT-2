...
const store = new MongoDBStore({
  uri: "mongodb+srv://abhisekpanda2004guddul:abhi@restaurant.xs79m.mongodb.net/?retryWrites=true&w=majority&appName=Restaurant",
  collection: "sessions",
});
...
mongoose
  .connect("mongodb+srv://abhisekpanda2004guddul:abhi@restaurant.xs79m.mongodb.net/?retryWrites=true&w=majority&appName=Restaurant", {})
  .then(() => {
